/*
 ...
 Source Schema         : mathematical_intelligence
...
-- Records of sys_user
-- ----------------------------
INSERT INTO `sys_user` VALUES (1, 'luntek', '123456', '13200001111', 'luntek@qq.com', 1, '广东省深圳市南山区', NULL, NULL, '1', '2019-03-29 10:28:17', '1', '2019-03-29 10:28:22');
...
CREATE TABLE `sys_task`  (
    ...
    `job_class` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL,
    `cron_expression` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL,
    `is_enable` tinyint(3) NULL DEFAULT NULL,
